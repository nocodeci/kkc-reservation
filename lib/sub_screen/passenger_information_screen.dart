                        ...
                        onPressed1: () {
                          ...
                          if (widget.length == manadf.length && data.length == widget.length && data1.length == widget.length) {
                            ...
                            if (mobileController.text.isNotEmpty &&
                                ...
                                manadf.isNotEmpty &&
                                listDynamic.isNotEmpty &&
                                listDynamicage.isNotEmpty) {

                              // TODO: Replace this with your booking confirmation logic
                              // Since Payment_Screen was removed, you can either:
                              // 1. Navigate to a booking confirmation screen
                              // 2. Show a success dialog
                              // 3. Call an API to complete the booking
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: Text('Your bus booking has been confirmed!'.tr),
                                    actions: [
                                      TextButton(
                                        onPressed: () {
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    enabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(10),
                                        borderSide: BorderSide(
                                            color: error1 ?Colors.red  : Colors.grey.withOpacity(0.4))),
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    enabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(10),
                                        borderSide: BorderSide(
                                            color: error2 ?Colors.red  : Colors.grey.withOpacity(0.4))),
