...
import 'package:kkc_reservation/All_Screen/login_screen.dart';
        ...
        title: Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('kkc_reservation'.tr,style: TextStyle(color: notifier.theamcolorelight,fontSize: 20,fontFamily: 'SofiaProBold'),),
            ),
          ],
        ),
      ),
