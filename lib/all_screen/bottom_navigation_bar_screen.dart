...
class _Bottom_NavigationState extends State<Bottom_Navigation> {
  // Liste des écrans disponibles dans la navigation
              ...
              items: <BottomNavigationBarItem>[
                BottomNavigationBarItem(
                  icon: homeController.selectpage == 0
                    ...
                    child: Image(
                        image: const AssetImage('assets/Bottom Fill Home.png'),
                        height: 22,
                        width: 22,
                ...
                BottomNavigationBarItem(
                  icon: homeController.selectpage == 1
                    ...
                    padding: const EdgeInsets.only(bottom: 5),
                    child: Image(
                        image: const AssetImage('assets/Bottom Fill Fill Ticket.png'),
                        height: 24,
                        width: 24,
                        color: notifier.theamcolorelight
                    ),
                ...
                BottomNavigationBarItem(
                  icon: homeController.selectpage == 3
                    ...
                    padding: const EdgeInsets.only(bottom: 5),
                    child: Image(
                        image: const AssetImage('assets/Bottom Fill Wallet.png'),
                        height: 19,
                        width: 19,
                        color: notifier.theamcolorelight
                    ),
                ...
                BottomNavigationBarItem(
                  icon: homeController.selectpage == 4
                    ...
                    padding: const EdgeInsets.only(bottom: 5),
                    child: Image(
                        image: const AssetImage('assets/Bottom Fill Account.png'),
                        height: 20,
                        width: 20,
                        color: notifier.theamcolorelight
                    ),
